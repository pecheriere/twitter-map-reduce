...
import main.java.app.mapper.AssociatedHashtagsMapper;
import main.java.app.models.Tweet;
import main.java.app.models.TweetCreator;
import main.java.app.reducer.AssociatedHashtagsReducer;
...
public class AssociatedHashtagsServlet extends HttpServlet {
    /**
     *
     */
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        Mapper<Entity, Pair<String,String>, Long> mapper = new AssociatedHashtagsMapper();
        ...
        Reducer<Pair<String, String>, Long, Entity> reducer = new AssociatedHashtagsReducer();
        Output<Entity, Void> output = new DatastoreOutput();


        MapReduceSpecification<Entity, Pair<String,String>, Long, Entity, Void>
